...
<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
    ...
    <a class="navbar-brand" href="home.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">Food Hunt</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <?php
	if(!empty($cust_id))
	{
	?>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item">
		     <a href="home.php" style="color:white;" class="nav-link">Home</a>
		  </li>
		  <li class="nav-item">
...
<div class="row">
   ...
   <?php
	  ...
	  vendor.fld_phone,vendor.fld_address,vendor.fld_logo,fuel.fuelname,fuel.cost,
	  fuel.quantity,fuel.paymentmode,fuel.fldimage from vendor inner join
	  fuel on vendor.fldvendor_id=fuel.fldvendor_id where fuel.fuel_id='$fid'");
