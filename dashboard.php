...
if(isset($delete))
{
	header("location:deletefuel.php?id=$delete");
}
if(isset($deleteVendor))
{
	header("location:deleteVendor.php?Vendorid=$deleteVendor");
}
$admin_info=mysqli_query($con,"select * from admin where fld_username='$admin_username'");
...
<div class="container">
	   ...
	   <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#ED2553;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" style="color:#BDDEFD;" id="viewitem-tab" data-toggle="tab" href="#viewitem" role="tab" aria-controls="viewitem" aria-selected="true">View Fuel Items</a>
          </li>
          <li class="nav-item">
	...
	<!--tab 1 starts-->   
	   <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="viewitem" role="tabpanel" aria-labelledby="viewitem-tab">
                 ...
                 <thead>
                    <tr>
                        <th scope="col">Pump_Id</th>
                            <th scope="col">Pump Logo</th>
                            <th scope="col">Fuel quantity</th>
                            <th scope="col">Pumps Name</th>
                            <th scope="col">Fuel Id</th>
                            
                            <th scope="col">Remove Pumps</th>
                     </tr>
                 </thead>
				 <tbody>
	<?php
	$query=mysqli_query($con,"select vendor.fldvendor_id,vendor.fld_name,vendor.fld_email,fuel.fuel_id,fuel.fuelname,fuel.quantity,fuel.fldimage from  vendor right join fuel on vendor.fldvendor_id=fuel.fldvendor_id");
	...
	?>			 
                    ...
                    <tr>
						...
						<td><img src="image/pump/<?php echo $row['fld_email']."/foodimages/" .$row['fldimage'];?>" height="50px" width="100px">
						<br><?php echo $row['fuelname'];?>
						</td>
						...
						<form method="post">
                        <td><a href=""><button type="submit" value="<?php echo $row['fuel_id']; ?>" name="delete"  class="btn btn-danger">Remove </button></td>
                        </form>
                   </tr>
		<?php
		}
...
<!--tab 1 ends-->	   
	...
	?>			 
                    ...
                    <tr>
						...
						<td><img src="image/pump/<?php echo $row['fld_email']."/" .$row['fld_logo'];?>" height="50px" width="100px"></td>
                        <th scope="row"><?php echo $row['fldvendor_id'];?></th>
						<td><?php echo $row['fld_name'];?></td>
		...
		?>		   
			 ...
			 <div class="tab-pane fade" id="orderstatus" role="tabpanel" aria-labelledby="orderstatus-tab">
			   ...
			   <tbody>
			   <?php			   
			   $rr=mysqli_query($con,"select * from myorder");
			   while($rrr=mysqli_fetch_array($rr))
			   {
				   $stat=$rrr['fldstatus'];
				   $foodid=$rrr['fld_fuel_id'];
				   $r_f=mysqli_query($con,"select * from fuel where fuel_id='$foodid'");
				   $r_ff=mysqli_fetch_array($r_f);
			   
			   ?>
			   <tr>
			   <td><?php echo $rrr['fld_order_id']; ?></td>
			   <td><a href="searchfuel.php?fuel_id=<?php echo $rrr['fld_fuel_id']; ?>"><?php echo $rrr['fld_fuel_id']; ?></td>
