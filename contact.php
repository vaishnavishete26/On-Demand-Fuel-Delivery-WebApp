...
tblvendor.fld_mob,tblvendor.fld_address,tblvendor.fld_logo,fuel.fuel_id,fuel.fuelname,fuel.cost,
fuel.quantity,fuel.paymentmode 
from tblvendor inner join fuel on tblvendor.fldvendor_id=fuel.fldvendor_id;");
...
//print_r($arr);
 ...
 if(isset($message))
 {
	 ...
	 echo $email;
	 echo $phone;
	 if(mysqli_query($con,"insert into message(fld_name,fld_email,fld_phone,fld_msg) values ('$name','$email','$phone','$msgtxt')"))
     {
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>+919721880722</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; 23-A ,North-East Campus, Mumbai<br>(24*7 Days)
