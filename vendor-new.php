    ...
    if(isset($_SESSION['id']))
{
	...
	if(isset($register))
     {
	$sql=mysqli_query($con,"select * from vendor where fld_email='$email'");
	...
	{
	mkdir("image/pump");
	mkdir("image/pump/$email");
	
	move_uploaded_file($_FILES['logo']['tmp_name'],"image/pump/$email/".$_FILES['logo']['name']);
	}
	$_SESSION['id']=$email;
	       ...
	       <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="home-tab">
			    ...
			    <form action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="name" value="<?php if(isset($r_name)) { echo $r_name;}?>" placeholder="Enter Petrol Station Name" name="r_name" required/>
                      </div>
	                  <div class="form-group">
