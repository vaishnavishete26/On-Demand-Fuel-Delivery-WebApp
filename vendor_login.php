...
if(isset($_SESSION['id']))
{
  ...
  if(isset($login))
  {
	$sql=mysqli_query($con,"select * from vendor where fld_email='$username' && fld_password='$pswd' ");
...
<head>
  <meta charset="UTF-8">
    <title>Petrol station Login</title>
...
<div class="middle" style=" position:fixed; padding:40px; border:1px solid #ED2553; left:30%; top:30%; width:400px;">
  <h3 style=" position: center">Petrol Pump Login</h3>
       <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#ED2553;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" id="home-tab" data-toggle="tab" href="#login" role="tab" aria-controls="home" aria-selected="true">Petrol station Login</a>
          </li>
            ...
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
			  ...
			  <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="username" placeholder="Enter Email Id" name="username" required/>
                        </div>
                        <div class="form-group">
