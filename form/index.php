...
if(isset($login))
{
	$query=mysqli_query($con,"select * from customer where fld_email='$email' && password='$password'");
...
if(isset($register))
{
	$query=mysqli_query($con,"select * from customer where fld_email='$email'");
	...
	{
		if(mysqli_query($con,"insert into customer (fld_name,fld_email,password,fld_mobile,address) values('$name','$email','$password','$mobile','$address')"))
    {
            ...
            <div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="profile-tab">
			    <form method="post" enctype="multipart/form-data">
				   ...
				   <div class="form-group">
                      ...
                      <input type="add" id="address" class="form-control" name="address" placeholder="" required>
                    </div>
